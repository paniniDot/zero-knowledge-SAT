...
\subsubsection{Dimostrazioni a conoscenza zero}
...
\begin{itemize}
    ...
    \item Si prendono $k$ valori distinti di $j$ per cui $v_j$ è un residuo quadratico modulo $n$ (cioè esiste un valore che se elevato al quadrato risulta congruo a $v_j \bmod n$). A questo punto si calcola $s_j$ come la più piccola radice in modulo dell'inverso di $v_j$ (si veda il capitolo sull'algebra modulare).
...
\begin{proof}
    ...
    \end{align*}
    Per ipotesi avevamo scelto 
\end{proof}


\subsection{Punti deboli (forse)}
